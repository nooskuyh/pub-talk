...
![Candidates](./public/imgs/bad.png){class="mx-auto max-h-90 object-contain rounded-xl"}
...
![Candidates](./public/imgs/good.png){class="mx-auto max-h-90 object-contain rounded-xl"}
...
![Candidates](./public/imgs/good2.png){class="mx-auto max-h-90 object-contain rounded-xl"}
...
<div class="flex flex-col items-center">
  <img
    src="./public/imgs/lower-trapezius.png"
    alt="Lower Trapezius"
    class="max-h-48 object-contain rounded my-1"
  />
</div>
...
<div class="flex flex-col items-center">
  <img
    src="./public/imgs/pectoralis-minor.jpg"
    alt="Pectoralis Minor"
    class="max-h-48 object-contain rounded my-1"
  />
</div>
...
<div class="flex flex-col items-center">
  <img
    src="./public/imgs/round-by-muscles.png"
    alt="rounded-shoulder"
    class="max-h-60 object-contain rounded my-1"
  />
</div>

<div text-center my-1 text-xs text-slate-700>
...
::note-box
<div text-xs leading-snug>
"Healthy individuals with a relatively short pectoralis minor resting length demonstrated scapular kinematic patterns similar to patterns previously reported for subjects with clinical shoulder impingement." <br> <strong>— Borstad & Ludewig, 2005</strong>
</div>
...
<div class="grid grid-cols-2 gap-4 my-2 items-center">
  <div class="rounded-lg p-2 bg-slate-50 flex items-center justify-center">
    <img
      src="./public/imgs/Kluemper.png"
      alt="Kluemper et al. Study"
      class="max-h-44 object-contain rounded"
    />
  </div>
  <div class="card">
    <h3>
      <span class="icon teal i-carbon:notebook"></span>
  ...
  <div v-click class="grid grid-cols-2 gap-4 mt-2">
    <div class="border border-rose-100 bg-rose-50/50 rounded-lg p-2 text-center">
      <div class="text-xs font-semibold text-rose-700 mb-1">Exercise Group (n = 24)</div>
      <div class="text-xl font-bold text-rose-600">−9.6 ± 7.3 mm</div>
      <div class="text-xs text-slate-500 mt-0.5">Significant forward posture reduction</div>
    </div>
    <div class="border border-slate-200 bg-slate-50 rounded-lg p-2 text-center">
      <div class="text-xs font-semibold text-slate-600 mb-1">Control Group (n = 15)</div>
      <div class="text-xl font-bold text-slate-600">−2.0 ± 6.9 mm</div>
      <div class="text-xs text-slate-500 mt-0.5">Minimal non-significant change</div>
    </div>
  </div>
...
<img
  src="./public/imgs/didwegethim.png"
  alt="Did we get him"
  class="mx-auto max-h-76 object-contain rounded-xl"
/>

::caption::

<div v-click class="text-center text-lg italic text-slate-700 -mt-30">
*Survives*
</div>
...
<div class="relative mx-auto w-fit">
  <img
    src="./public/imgs/multi-factor.png"
    alt="Multifactorial Scapular Kinematic Alterations"
    class="mx-auto max-h-50 object-contain rounded-xl block shadow-sm"
  />
  <div class="absolute bottom-2 inset-x-2 grid grid-cols-5 gap-2 text-center">
    <div class="bg-white/95 backdrop-blur border border-blue-300 text-blue-900 rounded-md py-1 px-1 text-xs font-bold shadow-sm">
      Serratus Anterior
    </div>
    <div class="bg-white/95 backdrop-blur border border-rose-300 text-rose-900 rounded-md py-1 px-1 text-xs font-bold shadow-sm">
      Upper Trapezius
    </div>
    <div class="bg-white/95 backdrop-blur border border-amber-300 text-amber-900 rounded-md py-1 px-1 text-xs font-bold shadow-sm">
      Pectoralis Minor
    </div>
    <div class="bg-white/95 backdrop-blur border border-purple-300 text-purple-900 rounded-md py-1 px-1 text-xs font-bold shadow-sm">
      Soft-Tissue Tightness
    </div>
    <div class="bg-white/95 backdrop-blur border border-emerald-300 text-emerald-900 rounded-md py-1 px-1 text-xs font-bold shadow-sm">
      Thoracic Kyphosis
    </div>
  </div>
</div>
...
<div class="relative mx-auto w-fit">
  <img
    src="./public/imgs/multi-treat.png"
    alt="Multifactorial Scapular Kinematic Alterations"
    class="mx-auto max-h-60 object-contain rounded-xl block shadow-sm"
  />
  <div class="absolute bottom-2 inset-x-2 grid grid-cols-5 gap-2 text-center">
    <div class="bg-white/95 backdrop-blur border border-blue-300 text-blue-900 rounded-md py-1 px-1 text-xs font-bold shadow-sm">
      Serratus Anterior
...
<div class="flex flex-col justify-center items-center h-full text-center space-y-7">
  <div class="text-2xl font-bold text-slate-800">What About Pain?</div>
  <div class="text-2xl font-bold text-slate-800">Are rounded shoulders truly bad?</div>
  <div class="text-2xl font-bold text-slate-800"> Do rounded shoulders really cause shoulder pain?</div>
</div>
...
<div class="space-y-3">
  ...
  <div class="card card-compact !p-3">
    <div class="flex items-center justify-between mb-2">
      <div class="flex items-center gap-1.5">
        <span class="icon teal i-carbon:search text-base" />
        <span class="font-bold text-slate-900 text-sm">Ratcliffe et al. (2014)</span>
      </div>
    ...
    <div class="grid grid-cols-12 gap-3 items-center">
      <div class="col-span-5 bg-slate-50 border border-slate-200 rounded-lg p-2.5 text-[13px] leading-relaxed text-slate-700">
      ...
      <div class="col-span-1 flex justify-center text-teal-600 font-bold text-xl">
        ➔
      </div>
      <div class="col-span-6 bg-teal-50/70 border border-teal-200 rounded-lg p-2.5 text-[13px] leading-relaxed text-teal-950">
  ...
  <div class="card card-compact !p-3">
    <div class="flex items-center justify-between mb-2">
      <div class="flex items-center gap-1.5">
        <span class="icon coral i-carbon:activity text-base" />
        <span class="font-bold text-slate-900 text-sm">Pecos-Martín et al. (2022)</span>
      </div>
    ...
    <div class="grid grid-cols-12 gap-3 items-center">
      ...
      <div class="col-span-1 flex justify-center text-rose-600 font-bold text-xl">
        ➔
      </div>
      <div class="col-span-6 bg-rose-50/70 border border-rose-200 rounded-lg p-2.5 text-[13px] leading-relaxed text-rose-950">
...
<div v-click class="wrong-overlay">
  <div class="bg-white border-2 border-black-500 rounded-2xl p-8 shadow-2xl text-center max-w-2xl transform scale-105">
...
<v-switch class="relative mx-auto w-fit">
  <template #0>
    <img
      src="./public/imgs/dig1.png"
      alt="Figure 1: Shoulder pain assessment and initial management decision tree"
      class="mx-auto max-h-80 object-contain rounded-xl block shadow-sm"
    />
  </template>
  <template #1>
    <img
      src="./public/imgs/dig2.png"
      alt="Figure 2: Management of rotator cuff tendinopathy decision tree"
      class="mx-auto max-h-80 object-contain rounded-xl block shadow-sm"
    />
  </template>
  <template #2>
    <img
      src="./public/imgs/current-treatments.png"
      alt="Figure 3: Overall clinical approach for shoulder pain"
      class="mx-auto max-h-80 object-contain rounded-xl block shadow-sm"
    />
  </template>
</v-switch>
...
<DeckTitle
  title="Let's
Become
a <span class='text-red-500 font-bold'>Bad</span> Developer!"
/>
...
<div class="space-y-2.5 text-[11px] leading-relaxed text-slate-700 mt-2">
